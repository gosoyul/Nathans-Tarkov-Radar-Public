...
public:
    static sio::object_message::ptr NewPlayerMessage(TarkovPlayer Player)
    {
        ...
        PlayerLocationMap["x"] = sio::int_message::create(Location.x);
        PlayerLocationMap["y"] = sio::int_message::create(Location.y);
        PlayerLocationMap["z"] = sio::int_message::create(Location.z);
        ...
        PlayerViewMap["x"] = sio::int_message::create(View.x);
        PlayerViewMap["y"] = sio::int_message::create(View.y);
        ...
        PlayerJson["id"] = sio::string_message::create(Info.PlayerName + Profile.GetPlayerID().GetString()); //Info.PlayerName + Profile.GetPlayerID().GetString()
    ...
    static sio::object_message::ptr AddLootMessage(TarkovLootItem Loot)
    {
        ...
        LootLocationMap["x"] = sio::int_message::create(Location.x);
        LootLocationMap["y"] = sio::int_message::create(Location.y);
        LootLocationMap["z"] = sio::int_message::create(Location.z);
